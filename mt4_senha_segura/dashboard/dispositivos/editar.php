...
if(isset($_POST['hostname']) && empty($_POST['hostname']) == false) {
	...
	$sql = "UPDATE dispositivos SET hostname = '$hostname', ip = '$ip', tipo = '$tipo', porta = '$porta', fabricante = '$fabricante' WHERE id = '$id'";
	$pdo->query($sql);
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              EDITAR AS INFORMAÇÕES DOS DISPOSITIVOS</div>
	<div class="container">
        <div class="card-body">
          <form method="POST" id="editar">
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="text"  name="hostname" id="inputHostname" class="form-control" value="<?php echo $dado['hostname']; ?>" placeholder="HOSTNAME" required="required" autofocus="autofocus">
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="text" id="inputIp" name="ip" class="form-control" value="<?php echo $dado['ip']; ?>" placeholder="IP" required="required">
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="text" id="inputPorta" name="porta" class="form-control" value="<?php echo $dado['porta']; ?>" placeholder="PORTA PARA CONEXÃO" required="required">
			...
			<div class="form-group">
				...
				<select name="fabricante" class="form-control" >
					<option value="<?php echo $dado['fabricante']; ?>"><?php echo $dado['fabricante']; ?></option>
