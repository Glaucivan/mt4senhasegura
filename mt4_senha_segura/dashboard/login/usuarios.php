   ...
   <body id="page-top">
	...
	if($sql->rowCount() > 0) {
		foreach($sql->fetchAll() as $dados) {
			...
			echo '<td><a class="far fa-edit" title="EDITAR" href="editar.php?id='.$dados['id'].'">EDITAR </a><a class="far fa-trash-alt" title="EXCLUIR" href="excluir.php?id='.$dados['id'].'">EXCLUIR</a></td>';
			echo '</tr>';
		}
	}
	?>
