      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="cadastrar.php">Cadastrar usuário</a>
            <a class="dropdown-item" href="usuarios.php">Todos os usuários</a>
          </div>
        </li>
        ...
        <div class="container-fluid">
          ...
          <!--Mostrar tabela com registros -->
            ...
            <div class="card-header">
              ...
              ATUALIZAR AS INFORMAÇÕES DE ACESSO AO SISTEMA</div>	
	<div class="container">
        <div class="card-body">
          <form method="POST" id="cadastro">
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="text"  name="nome" id="inputNome" class="form-control" placeholder="NOME" value="<?php echo $dado['nome']; ?>" required="required" autofocus="autofocus">
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="email" id="inputEmail" name="email" class="form-control" placeholder="E-MAIL" value="<?php echo $dado['email']; ?>" required="required">
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="password" id="inputSenha" name="senha" class="form-control" placeholder="SENHA" value="<?php echo $dado['senha']; ?>" required="required">
